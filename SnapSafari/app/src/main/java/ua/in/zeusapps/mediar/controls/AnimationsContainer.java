...
public class AnimationsContainer {
    ...
    public AnimationsContainer(ImageView imageView) {
        init(imageView);
    };
...
//    }
    ...
    private class GetImageDrawableTask extends AsyncTask<Integer, Void, Drawable>{
        ...
        private Resources currentResoruces;

        public GetImageDrawableTask(ImageView imageView) {
            mImageView = imageView;
            currentResoruces = imageView.getContext().getResources();
        }
        ...
        protected Drawable doInBackground(Integer... params) {
            if(Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB){
                return currentResoruces.getDrawable(params[0]);
            }
