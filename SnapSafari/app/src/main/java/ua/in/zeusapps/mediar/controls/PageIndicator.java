...
public class PageIndicator implements ViewPager.OnPageChangeListener {
    ...
    public PageIndicator(@NonNull Context context, @NonNull LinearLayout containerView, @NonNull LockableViewPager viewPager, @DrawableRes int drawableRes) {
        if (context == null) {
